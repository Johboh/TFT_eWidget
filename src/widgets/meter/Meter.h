...
class MeterWidget
{
  public:
    ...
    void analogMeter(uint16_t x, uint16_t y, float fullScale, const char *units, const char *s0, const char *s1, const char *s2, const char *s3, const char *s4, bool with_borders = true);
    // Draw meter meter at x, y and define full scale range plus the scale labels
    void analogMeter(uint16_t x, uint16_t y, float startScale, float endScale, const char *units, const char *s0, const char *s1, const char *s2, const char *s3, const char *s4, bool with_borders = true);
